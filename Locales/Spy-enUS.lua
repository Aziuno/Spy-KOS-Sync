...
StaticPopupDialogs["Spy_SetKOSReasonOther"] = {
	...
	OnAccept = function(self, data)
		...
		local reason = ""
		if editBox then
			reason = editBox:GetText()
		end
		local playerName = data or self.data
		if playerName then
...
-- KOS Sync
L["ShareKOSReasons"] = "Share KOS reasons with guild"
L["ShareKOSReasonsDescription"] = "Set this to automatically share Kill On Sight reasons with your guildmates."
L["KOSSyncNotifications"] = "Show KOS sync notifications"
L["KOSSyncNotificationsDescription"] = "Set this to show chat notifications when guildmates add or update KOS reasons."
L["KOSSyncDebug"] = "Enable KOS sync debug messages"
L["KOSSyncDebugDescription"] = "Set this to show detailed debug messages for KOS sync operations in chat. Useful for troubleshooting sync issues."
L["KOSReasonAddedBy"] = "added by"
L["KOSReasonReceived"] = "%s added KOS reason for %s: %s"
L["KOSRemovalReceived"] = "%s removed %s from KOS"
L["KOSPlayerAdded"] = "%s added %s to KOS"
...
L["StatsDetailReasons"] = "KOS Reasons"
L["StatsDetailGuildPvP"] = "Guild PvP Record"
L["StatsDetailGuildMember"] = "Guild Member"
L["StatsDetailRecord"] = "Record"
L["StatsDetailLastSeen"] = "Last Seen"
L["StatsDetailNoData"] = "No guild data available"
L["KOSGuildKill"] = "%s killed %s"
L["KOSGuildDeath"] = "%s was killed by %s"
L["Others"] = "others"
L["GuildDetails"] = "Guild Details"
L["Sync"] = "sync"
L["SyncDescription"] = "Request KOS sync from guildmates"
L["ForceSync"] = "forcesync"
L["ForceSyncDescription"] = "Force a full KOS sync (resets sync timestamps)"
L["KOSSyncSent"] = "KOS sync request sent to guild"
L["KOSSyncReceived"] = "Received KOS sync from %s (%d entries)"
L["KOSSyncSentTo"] = "Sent KOS sync to %s (%d entries)"
L["KOSSyncDisabled"] = "KOS sync is disabled in settings"
L["KOSSyncNoGuild"] = "You must be in a guild to sync KOS data"
L["KOSForceSyncStarted"] = "Force sync started - requesting full KOS data from guild"
L["SyncKOS"] = "Sync"
L["ForceSyncKOS"] = "Force"
